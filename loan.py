...
st.write('1:Means client will default loan,0:Means client will pay back loan')
result='Yes,Loan will default' if predictions[0]==1 else 'No,Loan will be paid back'
st.write(predictions[0],result)
